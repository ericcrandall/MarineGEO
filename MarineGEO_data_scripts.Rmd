...
class(fish_samples$otherCatalogNumbers)
...
class(invert_samples$basisofRecord)
class(invert_samples$catalogNumber)
class(invert_samples$otherCatalogNumbers)
class(invert_samples$organismScope)
...
class(meio_samples$basisofRecord)
...
arms_events$coordinateUncertaintyInMeters<-50
...
class(arms_samples$organismScope)
