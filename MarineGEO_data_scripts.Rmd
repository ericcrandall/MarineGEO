...
algae_samples$taxonRank<-as.character(algae_samples$taxonRank) # Melinda needs to populate this...
...
write.csv(MarineGEOHI2,"MarineGEOHI_data_1.0.csv",row.names = F)
